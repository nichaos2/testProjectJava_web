...
public class MaterialRest {
	...
	public MaterialRest(long id, String name, float energy_consum, int rank_energy_consum, float kg_CO2,
			int rank_kg_CO2, float bf_ratio, float avg_impact, float avg_impact_x_bfratio) {
		this.id = id;
		this.name = name;
